...
export default function Navbar() {
  ...
  return (
    <div className="bg-black relative h-24">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <Link href="/" className="-m-1.5 p-1.5">
              ...
              <img
                className="h-16 w-auto rounded-2xl bg-slate-400"
                src="https://images.deepai.org/art-image/144ea09216604e5c878b696a908fec45/design-a-modern-and-uplifting-logo-for-empower-your-p.jpg"
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <Link key={item.name} href={item.href} className="text-sm font-semibold leading-6 text-red-300">
                {item.name}
              </Link>
            ))}
          </div>
        ...
        <Dialog className="lg:hidden" open={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)}>
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-800 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-yellow-300">
