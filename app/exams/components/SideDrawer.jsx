...
const SideDrawer = () => {
  useEffect(() => {
    const showDrawerBtn = document.querySelector('[data-drawer-show="drawer-form"]');
    const hideDrawerBtn = document.querySelector('[data-drawer-hide="drawer-form"]');
    ...
    showDrawerBtn.addEventListener('click', openDrawer);
    hideDrawerBtn.addEventListener('click', closeDrawer);

    return () => {
      showDrawerBtn.removeEventListener('click', openDrawer);
      hideDrawerBtn.removeEventListener('click', closeDrawer);
    };
  }, []);
            ...
            <div className="flex">
              <div className="relative w-full">
                <input
                  type="search"
                  id="guests"
                  className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
